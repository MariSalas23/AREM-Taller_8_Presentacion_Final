...
- Practique una defensa breve de la arquitectura frente a preguntas.
...
- Entregar un resumen ejecutivo y una matriz de evaluación de riesgos arquitectónicos.
- Incluir una reflexión individual de cada integrante.
